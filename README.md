...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/newuoa-cpp-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/newuoa-cpp-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi global install newuoa-cpp
```
...
It is possible to list all of the versions of `newuoa-cpp` available on your platform:
...
```
pixi search newuoa-cpp --channel conda-forge
```
